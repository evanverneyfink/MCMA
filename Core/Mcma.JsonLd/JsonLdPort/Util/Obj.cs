...
namespace JsonLD.Util
{
    public class Obj
    {
        ...
        public static object Put(object map,
                                 string key1,
                                 string key2,
                                 string key3,
                                 object
        ...
        {
            ((IDictionary<string, object>)((IDictionary<string, object>)((IDictionary<string,
                                                                                object>)((IDictionary<string, object>)map)[key1])[key2])[key3])[key4]
                = value;
            return map;
        }
        ...
        {
            return Collections.Remove((IDictionary<string, object>)((IDictionary<string
                                                                           , object>)map)[k1],
                                      k2);
        }
